...
$code .= "\t\$lviewer = \$bootstrap::get_Link('view', ['href' => \$viewer, 'icon' => ICON_VIEW, 'text' => lang('App.View'), 'class' => 'btn-primary']);\n";
$code .= "\t\$leditor = \$bootstrap::get_Link('edit', ['href' => \$editor, 'icon' => ICON_EDIT, 'text' => lang('App.Edit'), 'class' => 'btn-secondary']);\n";
$code .= "\t\$ldeleter = \$bootstrap::get_Link('delete', ['href' => \$deleter, 'icon' =>ICON_DELETE, 'text' => lang('App.Delete'), 'class' => 'btn-danger']);\n";
$code .= "\t\$options = \$bootstrap::get_BtnGroup('options', ['content'=>[\$lviewer, \$leditor, \$ldeleter]]);\n";
$code .= "\t//[Fields]----------------------------------------------------------------------------------------------------------\n";
