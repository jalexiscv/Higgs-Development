...
$code .= "\$table = \$bootstrap->get_DynamicTable(array(\n";
$code .= "    'id' => 'table-' . lpk(),\n";
$code .= "    'data-url' => '/{$g->slc_module}/api/{$g->slc_component}/json/list/' . lpk(),\n";
$code .= "    'buttons' => array(\n";
$code .= "        'create' => array('icon' =>ICON_ADD,'text'=>lang('App.Create'), 'href' => '/{$g->slc_module}/{$g->slc_component}/create/'.lpk(), 'class' => 'btn-secondary'),\n";
$code .= "    ),\n";
$code .= "    'cols' => array(\n";
...
$code .= "\$card = \$bootstrap->get_Card(\"card-view-service\", array(\n";
$code .= "\t \"title\" => lang('{$g->ucf_component}.list-title'),\n";
$code .= "\t \"header-back\" => \$back,\n";
$code .= "\t \"alert\" => array(\"icon\" => ICON_INFO, \"type\" => \"info\", \"title\" => lang('{$g->ucf_component}.list-title'), \"message\" => lang('{$g->ucf_component}.list-description')),\n";
$code .= "\t \"content\" => \$table,\n";
$code .= "));\n";
$code .= "echo(\$card);\n";
$code .= "?>\n";
