...
foreach ($fields as $field) {
    if ($field == 'author') {
        ...
        $code .= "\$f->fields[\"{$field}\"] = \$f->get_FieldView(\"{$field}\", ['value' => \$r[\"{$field}\"],'proportion'=>'col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12']);\n";
    }
}
...
$code .= "\$f->fields['edit'] =\$f->get_Button('edit', ['href' =>'/{$g->slc_module}/{$g->slc_component}/edit/'. \$oid,'icon'=>ICON_EDIT,'text' =>lang('App.Edit'),'class'=>'btn btn-secondary','proportion' =>'col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right']);\n";
...
$code .= "\$f->groups['gz'] = \$f->get_Buttons(['fields'=>\$f->fields['edit'].\$f->fields['cancel']]);\n";
