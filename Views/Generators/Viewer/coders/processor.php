...
$code .= "        . '<p class=\"text-center pb-2\">' . lang(\"{$ucf_module}_{$ucf_component}.view-success-message\") . '</p>';\n";
...
$code .= "    \$_body = '<div class=\"text-center py-3\">' . \$_icon . '</div>'\n";
$code .= "        . '<p class=\"text-center pb-2\">' . lang(\"{$ucf_module}_{$ucf_component}.view-noexist-message\") . '</p>';\n";
