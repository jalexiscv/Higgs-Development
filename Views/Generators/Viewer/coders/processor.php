...
$code .= "    \$_msg_col  = BS5::col(['attributes' => ['class' => 'text-center pb-2'], 'content' => lang(\"{$ucf_module}_{$ucf_component}.view-success-message\")]);\n";
...
$code .= "    \$c = BS5::card([\n";
$code .= "        'headerTitle' => lang(\"{$ucf_module}_{$ucf_component}.view-success-title\"),\n";
...
$code .= "    \$_msg_col  = BS5::col(['attributes' => ['class' => 'text-center pb-2'], 'content' => lang(\"{$ucf_module}_{$ucf_component}.view-noexist-message\")]);\n";
...
$code .= "    \$c = BS5::card([\n";
$code .= "        'headerTitle' => lang(\"{$ucf_module}_{$ucf_component}.view-noexist-title\"),\n";
