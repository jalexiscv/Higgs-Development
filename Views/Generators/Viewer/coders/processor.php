...
$code .= "    \$_msg_col  = (string)BS5::col(['attributes' => ['class' => 'text-center pb-2'], 'content' => lang(\"{$ucf_module}_{$ucf_component}.view-success-message\")]);\n";
...
$code .= "    \$_msg_col  = (string)BS5::col(['attributes' => ['class' => 'text-center pb-2'], 'content' => lang(\"{$ucf_module}_{$ucf_component}.view-noexist-message\")]);\n";
