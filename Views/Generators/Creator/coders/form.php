...
$code .= "\$f->fields['cancel']=\$f->get_Cancel('cancel', ['href' =>\$r['back'], 'text' =>lang('App.Cancel'), 'type' => 'secondary', 'proportion' =>'col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right']);\n";
$code .= "\$f->fields['submit'] =\$f->get_Submit('submit', ['value' =>lang('App.Create'), 'proportion' =>'col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-left']);\n";
