...
$code .= "    \$_icon_col = (string)BS5::col(['attributes' => ['class' => 'text-center py-3'], 'content' => BS5::icon(['icon' => 'triangle-exclamation', 'style' => 'duotone', 'size' => '4x'])]);\n";
$code .= "    \$_msg_col  = (string)BS5::col(['attributes' => ['class' => 'text-center pb-2'], 'content' => lang(\"{$ucf_module}_{$ucf_component}.create-duplicate-message\")]);\n";
$code .= "    \$_btn_col  = (string)BS5::col(['attributes' => ['class' => 'text-center pb-3'], 'content' => BS5::button(['content' => lang('App.Continue'), 'variant' => 'warning', 'size' => 'md', 'attributes' => ['href' => \$l['back']]])]);\n";
$code .= "    \$_content  = (string)BS5::row(['attributes' => ['class' => 'justify-content-center'], 'content' => \$_icon_col.\$_msg_col.\$_btn_col]);\n";
$code .= "    \$c = BS5::card([\n";
$code .= "        'header' => [\n";
$code .= "            'title' => lang(\"{$ucf_module}_{$ucf_component}.create-duplicate-title\"),\n";
...
$code .= "    \$_icon_col = (string)BS5::col(['attributes' => ['class' => 'text-center py-3'], 'content' => BS5::icon(['icon' => 'circle-check', 'style' => 'duotone', 'size' => '4x'])]);\n";
$code .= "    \$_msg_col  = (string)BS5::col(['attributes' => ['class' => 'text-center pb-2'], 'content' => sprintf(lang(\"{$ucf_module}_{$ucf_component}.create-success-message\"), \$d['{$fields[0]}'])]);\n";
$code .= "    \$_btn_col  = (string)BS5::col(['attributes' => ['class' => 'text-center pb-3'], 'content' => BS5::button(['content' => lang('App.Continue'), 'variant' => 'success', 'size' => 'md', 'attributes' => ['href' => \$l['back']]])]);\n";
$code .= "    \$_content  = (string)BS5::row(['attributes' => ['class' => 'justify-content-center'], 'content' => \$_icon_col.\$_msg_col.\$_btn_col]);\n";
$code .= "    \$c = BS5::card([\n";
$code .= "        'header' => [\n";
$code .= "            'title' => lang(\"{$ucf_module}_{$ucf_component}.create-success-title\"),\n";
