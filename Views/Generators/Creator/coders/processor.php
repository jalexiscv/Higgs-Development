...
$code .= "        . '<p class=\"text-center pb-2\">' . lang(\"{$ucf_module}_{$ucf_component}.create-duplicate-message\") . '</p>';\n";
$code .= "    \$_continue = BS5::button(['content' => lang('App.Continue'), 'variant' => 'warning', 'size' => 'md', 'attributes' => ['href' => \$l['back']]]);\n";
$code .= "    \$_content = \$_body . '<div class=\"text-center pb-3\">' . (string)\$_continue . '</div>';\n";
$code .= "    \$c = BS5::card([\n";
$code .= "        'header' => [\n";
...
$code .= "    \$_body = '<div class=\"text-center py-3\">' . \$_icon . '</div>'\n";
$code .= "        . '<p class=\"text-center pb-2\">' . sprintf(lang(\"{$ucf_module}_{$ucf_component}.create-success-message\"), \$d['{$fields[0]}']) . '</p>';\n";
$code .= "    \$_continue = BS5::button(['content' => lang('App.Continue'), 'variant' => 'success', 'size' => 'md', 'attributes' => ['href' => \$l['back']]]);\n";
$code .= "    \$_content = \$_body . '<div class=\"text-center pb-3\">' . (string)\$_continue . '</div>';\n";
$code .= "    \$c = BS5::card([\n";
$code .= "        'header' => [\n";
