...
// Shared context for all Creator coders — included by each coder file.
...
$g->namespaced = $g->has_options
    ? "App\\Modules\\{$g->ucf_module}\\Views\\{$g->ucf_component}\\{$g->ucf_options}\\Creator\\"
    : "App\\Modules\\{$g->ucf_module}\\Views\\{$g->ucf_component}\\Creator\\";
