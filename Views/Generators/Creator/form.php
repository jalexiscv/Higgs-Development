...
$f->fields['cancel'] = $f->get_Cancel('cancel', ['href' => '/development/generators/list/' . lpk(), 'text' => lang('App.Cancel'),
    'type' => 'secondary', 'proportion' => 'col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right']);
$f->fields['submit'] = $f->get_Submit('submit', ['value' => 'Guardar Creador', 'proportion' => 'col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-left']);
/*
 * -----------------------------------------------------------------------------
 * [Groups]
 * -----------------------------------------------------------------------------
