...
$pathfiles = APPPATH . "Modules/{$ucf_module}/Views/{$ucf_component}/_Delete";
...
$f->fields['submit'] = $f->get_Submit('submit', ['value' => 'Guardar Eliminador', 'proportion' => 'col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-left']);
/*
 * -----------------------------------------------------------------------------
 * [Groups]
 * -----------------------------------------------------------------------------
...
$card = $bootstrap->get_Card('card-view-service', [
    'title' => lang('Nexus.generators-deleters'),
    'header-back' => '',
    'content' => $f,
]);
echo($card);
