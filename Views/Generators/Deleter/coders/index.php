...
$singular = $g->has_options
    ? "{$g->slc_module}-{$g->slc_component}-{$g->slc_options}-delete"
    : "{$g->slc_module}-{$g->slc_component}-delete";
$plural = $g->has_options
    ? "{$g->slc_module}-{$g->slc_component}-{$g->slc_options}-delete-all"
    : "{$g->slc_module}-{$g->slc_component}-delete-all";
