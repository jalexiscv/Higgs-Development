...
$code .= "        . '<p class=\"text-center pb-2\">' . lang(\"{$ucf_module}_{$ucf_component}.delete-success-message\") . '</p>';\n";
...
$code .= "    \$_body = '<div class=\"text-center py-3\">' . \$_icon . '</div>'\n";
$code .= "        . '<p class=\"text-center pb-2\">' . lang(\"{$ucf_module}_{$ucf_component}.delete-noexist-message\") . '</p>';\n";
