...
$code .= "    \$_msg_col  = BS5::col(['attributes' => ['class' => 'text-center pb-2'], 'content' => lang(\"{$ucf_module}_{$ucf_component}.delete-success-message\")]);\n";
...
$code .= "    \$c = BS5::card([\n";
$code .= "        'headerTitle' => lang(\"{$ucf_module}_{$ucf_component}.delete-success-title\"),\n";
...
$code .= "    \$_msg_col  = BS5::col(['attributes' => ['class' => 'text-center pb-2'], 'content' => lang(\"{$ucf_module}_{$ucf_component}.delete-noexist-message\")]);\n";
...
$code .= "    \$c = BS5::card([\n";
$code .= "        'headerTitle' => lang(\"{$ucf_module}_{$ucf_component}.delete-noexist-title\"),\n";
