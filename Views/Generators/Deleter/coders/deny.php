...
if (count($eid) == 3) {
    $namespaced = "App\\Modules\\{$ucf_module}\\Views\\{$ucf_component}\\{$ucf_options}\\Delete\\deny.php";
} else {
    $namespaced = "App\\Modules\\{$ucf_module}\\Views\\{$ucf_component}\\Delete\\deny.php";
}
