...
// Shared context for all Editor coders — included by each coder file.
...
$g->namespaced = $g->has_options
    ? "App\\Modules\\{$g->ucf_module}\\Views\\{$g->ucf_component}\\{$g->ucf_options}\\Editor\\"
    : "App\\Modules\\{$g->ucf_module}\\Views\\{$g->ucf_component}\\Editor\\";
