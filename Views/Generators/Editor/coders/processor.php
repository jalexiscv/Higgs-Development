...
$code .= "        . '<p class=\"text-center pb-2\">' . lang(\"{$g->ucf_module}_{$g->ucf_component}.edit-success-message\") . '</p>'\n";
...
$code .= "    \$c = BS5::card([\n";
$code .= "        'header' => [\n";
$code .= "            'title' => lang(\"{$g->ucf_module}_{$g->ucf_component}.edit-success-title\"),\n";
...
$code .= "    \$_body = '<div class=\"text-center py-3\">' . \$_icon . '</div>'\n";
$code .= "        . '<p class=\"text-center pb-2\">' . sprintf(lang(\"{$g->ucf_module}_{$g->ucf_component}.edit-noexist-message\"), \$d['{$fields[0]}']) . '</p>'\n";
...
$code .= "    \$c = BS5::card([\n";
$code .= "        'header' => [\n";
$code .= "            'title' => lang(\"{$g->ucf_module}_{$g->ucf_component}.edit-noexist-title\"),\n";
