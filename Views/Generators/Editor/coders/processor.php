...
$code .= "    \$_icon_col = BS5::col(['attributes' => ['class' => 'text-center py-3'], 'content' => BS5::icon(['icon' => 'circle-check', 'style' => 'duotone', 'size' => '4x'])]);\n";
$code .= "    \$_msg_col  = BS5::col(['attributes' => ['class' => 'text-center pb-2'], 'content' => lang(\"{$ucf_module}_{$ucf_component}.edit-success-message\")]);\n";
$code .= "    \$_btn_col  = BS5::col(['attributes' => ['class' => 'text-center pb-3'], 'content' => BS5::button(['content' => lang('App.Continue'), 'variant' => 'success', 'size' => 'md', 'attributes' => ['href' => \$l['back']]])]);\n";
$code .= "    \$_content  = BS5::row(['attributes' => ['class' => 'justify-content-center bg-success text-white p-3'], 'content' => \$_icon_col.\$_msg_col.\$_btn_col]);\n";
$code .= "    \$c = BS5::card([\n";
$code .= "        'headerTitle' => lang(\"{$ucf_module}_{$ucf_component}.edit-success-title\"),\n";
$code .= "        'headerClass' => 'bg-success border-success text-white',\n";
$code .= "        'content'     => \$_content,\n";
$code .= "        'attributes'  => ['class' => 'border-success shadow-sm'],\n";
$code .= "    ]);\n";
$code .= "} else {\n";
$code .= "    \$_icon_col = BS5::col(['attributes' => ['class' => 'text-center py-3'], 'content' => BS5::icon(['icon' => 'triangle-exclamation', 'style' => 'duotone', 'size' => '4x'])]);\n";
$code .= "    \$_msg_col  = BS5::col(['attributes' => ['class' => 'text-center pb-2'], 'content' => sprintf(lang(\"{$ucf_module}_{$ucf_component}.edit-noexist-message\"), \$d['{$fields[0]}'])]);\n";
$code .= "    \$_btn_col  = BS5::col(['attributes' => ['class' => 'text-center pb-3'], 'content' => BS5::button(['content' => lang('App.Continue'), 'variant' => 'warning', 'size' => 'md', 'attributes' => ['href' => \$l['back']]])]);\n";
$code .= "    \$_content  = BS5::row(['attributes' => ['class' => 'justify-content-center bg-warning text-dark p-3'], 'content' => \$_icon_col.\$_msg_col.\$_btn_col]);\n";
$code .= "    \$c = BS5::card([\n";
$code .= "        'headerTitle' => lang(\"{$ucf_module}_{$ucf_component}.edit-noexist-title\"),\n";
$code .= "        'headerClass' => 'bg-warning border-warning text-dark',\n";
$code .= "        'content'     => \$_content,\n";
