...
$code .= "    \$_msg_col  = (string)BS5::col(['attributes' => ['class' => 'text-center pb-2'], 'content' => lang(\"{$ucf_module}_{$ucf_component}.edit-success-message\")]);\n";
...
$code .= "    \$_msg_col  = (string)BS5::col(['attributes' => ['class' => 'text-center pb-2'], 'content' => sprintf(lang(\"{$ucf_module}_{$ucf_component}.edit-noexist-message\"), \$d['{$fields[0]}'])]);\n";
