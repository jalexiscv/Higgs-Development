...
$f->fields['submit'] = $f->get_Submit('submit', ['value' => 'Guardar Editor', 'proportion' => 'col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-left']);
/*
 * -----------------------------------------------------------------------------
 * [Groups]
 * -----------------------------------------------------------------------------
...
$card = $bootstrap->get_Card('card-view-service', [
    'title' => lang('Nexus.generators-editors'),
    'header-back' => '',
    'content' => $f,
]);
echo($card);
