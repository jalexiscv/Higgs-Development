...
$options = array(
    array("href" => "/development/tools/modules/generator/" . lpk(), "title" => "Generador de módulos", "icon" => "fas fa-tasks"),
    array("href" => "/development/tools/texttophp/generator/" . lpk(), "title" => "Texto a PHP", "icon" => "fas fa-tasks"),
    array("href" => "/development/tools/poeditor/generator/" . lpk(), "title" => "PoEditor", "icon" => "fas fa-tasks"),
);
